# Import required librarie# Import required libraries
import pandas as pd
import dash
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(
                                            id='site-dropdown',
                                            options=[ 
                                                        {'label': opzione, 'value': opzione} for opzione in launch_sites
                                                    ],
                                            # Opzione predefinita
                                            value='ALL',
...
# Callback per aggiornare l'output in base alla selezione nel dropdown
